...
//address: 0x7FEfF69F017497C9208B08F30e40243ea43E6dD7
...
contract Metaverse is ERC721, Ownable{
    ...
    // Constructor
    constructor() ERC721("SEBAVERSE", "SEB"){}

     // Counters to regulate the current amount of NFT Token minted
     ...
     function mint(string memory _building_name, int8 _w, int8 _h, int8 _d, int8 _x, int8 _y, int8 _z) public payable {
         require(supply.current() <= maxSupply,  "Max supply achieved.");
     ...
     // Extract of ethers from the Smart Contract to Owner
